<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%> <!DOCTYPE HTML> <html> <head> <meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"> <title>Web Analytics</title> <script src="/JS/jquery-2.1.0.js"></script> <link href="/css/bootstrap.css" rel="stylesheet" type="text/css"/> <script src="/JS/bootstrap.js"></script> <script src="/JS/jquery.tablesorter.min.js"></script> <link rel="stylesheet" href="/css/jquery-ui.css"> <script src="/JS/jquery-ui.js"></script>  <script type="text/javascript" src="/JS/jScripts.js"></script> <script type="text/javascript" src="/JS/util.js"></script> <script type="text/javascript" src="/JS/profileload.js"></script> <script type="text/javascript" src="/JS/notify.min.js"></script> <script>
 ...
 <div class="col-sm-6"> <select class="form-control" id="accountName"></select> </div> 
 </div> <div class="form-group"> <label class="col-sm-4 control-label">Webproperties<span id="required">*</span>
 </label> <div class="col-sm-6"> <select class="form-control" id="propName"></select> </div> </div> <div class="form-group"> 
 <label class="col-sm-4 control-label">Profile<span id="required">*</span></label> <div class="col-sm-6"> 
 <select class="form-control" id="profName"></select> </div> </div> <div class="form-group"> 
 <label class="col-sm-4 control-label ">Table Id<span id="required">*</span></label> <div class="col-sm-6">
  ...
  </div> <div class="form-group"> <label class="col-sm-4 control-label">Dimension<span id="required">*</span>
  ...
  </div> <div class="form-group"> <label class="col-sm-4 control-label">Metrics<span id="required">*</span></label> 
  <div class="col-sm-6"> <input type="text" class="form-control query" placeholder="Ex. ga:visits" id='metric_value' required> </div>
   </div> <div class="form-group"> <label class="col-sm-4 control-label">Segment</label> <div class="col-sm-6"> 
   <input type="text" class="form-control" id="segment" placeholder="Ex. dynamic::ga:country=~Pakistan"> </div> </div> 
   <div class="form-group"> <label class="col-sm-4 control-label">Filter</label> <div class="col-sm-6"> 
   <input type="text" class="form-control query" id="filter" placeholder="Ex. ga:city==Chennai"> </div> </div>
    <div class="form-group"> <label class="col-sm-4 control-label">Sort</label> <div class="col-sm-6"> 
    <input type="text" class="form-control " id="sort" placeholder="Ex. ga:visits"> </div> </div>
     <div class="form-group"> <label class="col-sm-4 control-label">Start Date<span id="required">*</span></label>
      <div class="col-sm-6"> <input type="text" class="form-control datepicker query" id="startdate" placeholder="Click & Select Start Date" required> </div>
       </div> <div class="form-group"> <label class="col-sm-4 control-label">End Date<span id="required">*</span></label> <div class="col-sm-6"> 
       <input type="text" class="form-control datepicker query" id="enddate" placeholder="Click & Select End Date" required> </div> </div> 
       <div class="form-group"> <label class="col-sm-4 control-label">MaxResults</label> <div class="col-sm-6">
        <input type="text" class="form-control" id="maxResults" value=100> </div> </div> 
         <div class="form-group"> <label class="col-sm-4 control-label">StartIndex</label> <div class="col-sm-6">
        <input type="text" class="form-control" id="startIndex" value=1> </div> </div><div class="form-group">
         ...
         <div class="col-sm-offset-3 col-sm-4"> <button type="button" class="btn btn-info" id="getdata">Get Data</button> </div> </div> </form> </div>
          <div class="col-sm-4"><div class="col-sm-12" id="emaildivi">
          <div><input type="button" value="" id="email" data-toggle="modal" data-target="#myModal"/>
          <input type="email" id="emailId"><input type="button" value="Send" id="sendEmail">
           <input type='button' value='' id='download'/></div><div id="vh"></div></div>
           <div class="col-sm-12" id="userProfile"><div class="col-sm-12" id="lastresult">Get Last Result</div>
           <div class="col-sm-12" id="profilelists"><b>Userdefined Profile List</b></div>
           <div id="getuserprofile"></div><br/></div></div> </div> <div class='col-sm-12' id="gaheader"> <div> 
           <button type="button" id="showQuery">ShowQuery</button>&nbsp;&nbsp; 
           <select id="dimension_grp"></select> &nbsp;&nbsp; <select id="dimension_srh"></select>&nbsp;&nbsp; 
           <input type='text' id="dimen_val">&nbsp; <button type="button" id="srch_dimen">Search</button> &nbsp;&nbsp;<select id="noofresult">
           <option value=0>Select the No rows</option><option value=10>10</option><option value=20>20</option>
           ...
           <button type="button" id="custom" data-toggle="modal" data-target="#myModal1" >Customization</button></div> </div>
            ...
            <form class='form-horizontal' role='form'> <div class='form-group'> <label class="col-sm-2 control-label">From</label>
            ...
            <div class="modal-dialog"> <div class="modal-content"> <div class="modal-header"> 
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> 
            <h4 class="modal-title" id="myModalLabel">Customization </h4> </div>
             <div class="modal-body"> 
